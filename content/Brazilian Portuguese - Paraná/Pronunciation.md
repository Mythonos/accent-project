...
There is a tendency for the voiceless dental fricative /θ/ to realized as a voiceless labiodental fricative /f/ when found in the middle of a word.
...
![[../Assets/L to W.wav]]
“It did everything that the other ten months that it was just in *schoo***u** in in classes.”
#### Pʰ (Aspirated P)

Although it is inconsistent, there is some tendency to aspirate word initial P. 

![[../Assets/apirate p 2.wav]]
“So uh my grandpa, he *passed* really young.”

![[../Assets/aspirate p.wav]]
“Or even French is easier to read for a *Portuguese* *speaker*, an Italian *speaker* because we kinda have from like the same root.”
...
![[../Assets/Tatiana Goat Vowel.wav]]
“*So*, when I was *gr**ow**ing* up, I had English in school, but it was like once a week for like forty-five minutes, *so* it’s not something that, we just learned words, you *kn**ow*** like, oh book, pencil, you *kn**ow*** like things like this, not necessarily like make sentences.”
...
For speakers of Brazilian Portuguese, the long e sound \[iː] appears to lose the length resulting in simply a +high, +front vowel \[i]. There are times in our accent donor's speech where the vowel seems to maintain the length generally found in the American English FLEECE vowel.
...
Secondary articulations are the result of combining two or three simpler consonants without obscuring the first consonant. Tatiana explained that for speakers of Brazilian Portuguese, the alveolar plosives \[t, d] when followed by the vowel \[i] have a tendency to combine into a more complex consonant, a ‘cha’ or ‘jya’ sound, which can be heard in the following clips. 


![[../Assets/secondary articulation 1.wav]]

![[../Assets/secondary articulation 2.wav]]
...
Here are some more examples of the final \[l] to \[u]. Note that Tatiana says sentence final, though I believe that she means word final. 
